    ...
    <?php 
      ...
      ?>
        ...
        <div id="content_container">
       	  <div id="header"> <div class="header_content_mainline"> Добрый день, студент </div> <div id="header_content_tagline">  </div>
          
          
</div>
           
                 <div id="header_lower">  <div id="header_content_boxline">Какие планы на сегодня?<div id="header_content_boxcontent">
...
<p>
    <label>А планы?<br></label>
    <input name="plan" type="text" size="30" maxlength="">
    </p>
...
<!--**** Кнопочка (type="submit") отправляет данные на страничку save_user.php ***** --> 
            ...
            <div id="header_content_boxline">Ну время покажет</div> 
          <div id="header_content_boxcontent">
		  <?php
include ("bd.php");
// выполнение SQL запроса и получение всех записей (строк) из таблицы `users`
...
{ // вывод данных
$b=$a++;
  echo '<p>  '.$b.')  '.$row['login'].' <br>  '.$row['plan'].'</p>';
}// /while
?>
          </div>     
        </div>   </div>
